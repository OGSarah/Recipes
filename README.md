...
| SwiftData behind `FavoritesStoring` | SwiftData is an implementation detail, not the architecture — the view models never import it. |
...
> _Screenshots to be added under `Screenshots/`._

| Browse | Search | Recipe detail | Favorites |
| :---: | :---: | :---: | :---: |
| _Browse_ | _Search_ | _Detail_ | _Favorites_ |
